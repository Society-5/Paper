...
\newcommand{\titleGP}{\begingroup
	...
	{\LARGE Robosapien - model of AI traveler \\ \small{Towards Future Society 5.0: Modeling, Exploration \& Understanding}}\\[0.2\baselineskip]
	
	\rule{\textwidth}{0.4pt}\vspace{-\baselineskip}\vspace{3.2pt}
	\rule{\textwidth}{1.6pt}\\[\baselineskip]
	%\begin{wrapfigure}{l}{0.35\textwidth}
		\includegraphics[height=0.35\textwidth]{robot.png}
	%\end{wrapfigure}
...
\begin{document}
	...
	\begin{abstract}
		...
		between the two disciplines. Dreams like human assisted AI, exoskeletons and robots controlled
		remotely with an interactive humanoid interface are already a reality. \\
		
		Robosapiens is a robot that allows us to perform tasks such as other planets investigation (e.g. Mars planet - Musk plans) using a mixed reality.\\
